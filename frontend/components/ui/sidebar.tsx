      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-(--sidebar-width) bg-background p-0 text-foreground [&>button]:hidden border-0"
            style={
              {
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[state=expanded]:ml-(--sidebar-width) peer-data-[state=collapsed]:ml-0",
